...
# Example usage:
data_path = '/path/to/datasets/encoder_name.csv'
generate_kfold_splits(data_path=data_path, 
                      num_splits=5, 
                      random_state=42,
                      filename='encoder_name.csv',
                      output_filename='encoder_name_5fold_splits.csv',
                      counts_filename='encoder_name_5fold_counts.csv')
